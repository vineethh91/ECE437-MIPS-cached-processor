...
#lab 4
cpu.vhd : mycpu.vhd alu.vhd ander.vhd bintohexDecoder.vhd controller.vhd cpuStaller.vhd dcache.vhd dcache_ctrl.vhd dcache_ram.vhd forwardingUnit.vhd hazardDetectionUnit.vhd hitcounter.vhd icache.vhd inverter.vhd luiShifter.vhd memoryArbiter.vhd mux1Bit.vhd mux5Bit.vhd mux21BitTo21Bit.vhd mux32Bit.vhd mux32BitThreeToOne.vhd orer.vhd pcReg.vhd pcUpdate.vhd pcWriteEnableControl.vhd pipelineRegister_IF_ID.vhd pipelineRegister_ID_EX.vhd pipelineRegister_EX_MEM.vhd pipelineRegister_MEM_WB.vhd ram.vhd registerFile.vhd signExtender.vhd twoInputAdder.vhd VarLatRAM.vhd
cpuTest.vhd : cpu.vhd
tb_cpu.vhd : cpu.vhd
